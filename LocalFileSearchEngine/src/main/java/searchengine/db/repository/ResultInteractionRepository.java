...
import searchengine.db.sql.ResultInteractionSql;
...
public class ResultInteractionRepository {
    ...
    public void recordClick(String path) {
        recordInteraction(ResultInteractionSql.UPSERT_RESULT_CLICK, path);
    }

    public void recordCopyPath(String path) {
        recordInteraction(ResultInteractionSql.UPSERT_COPY_PATH, path);
    }
