...
import searchengine.db.sql.SearchHistorySql;
...
public class SearchHistoryRepository {
    ...
    public void recordSearch(String queryText) {
        try (PreparedStatement ps = connection.prepareStatement(SearchHistorySql.UPSERT_SEARCH_HISTORY)) {
    ...
    public List<String> findSuggestions(String prefix, int limit) {
        ...
        try (PreparedStatement ps = connection.prepareStatement(SearchHistorySql.FIND_SEARCH_SUGGESTIONS)) {
